...
import { CenterCallBtn, CloseBtn, LoginBtn, LoginInfo, MyInfoBox, MyPage, PhoneLogo, RegiBtn, SubBox, TopBar, TopBarText } from "./myPage/MyPageBar";
...
export default function MyPageBar({ activeMyPage, setActiveMyPage }: Props) {
      ...
      <MyPage>
        <TopBar>
          ...
          <MyInfoBox>
            ...
            />
            <Link href={'/Sign-in'}>
              <LoginBtn onClick={handleCloseBtn}>
                로그인
              </LoginBtn>
            </Link>
            <Link href={'/Sign-up'}>
              <RegiBtn onClick={handleCloseBtn}>
                회원가입
              </RegiBtn>
            </Link>
            <LoginInfo>
