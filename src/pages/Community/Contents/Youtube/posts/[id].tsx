...
export const getStaticPaths: GetStaticPaths = async() => {
  const youtubes = (await import('../../../../../../YoutubeDummy.json')).default;
  const paths = youtubes.map((youtubes: Youtube) => ({ params: { id: youtubes.id } }));
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  const youtubes = (await import('../../../../../../YoutubeDummy.json')).default;
  const youtube = youtubes.find((youtubes: Youtube) => youtubes.id === params?.id);
